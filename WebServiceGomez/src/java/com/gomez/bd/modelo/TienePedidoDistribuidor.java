...
public class TienePedidoDistribuidor implements Serializable {
    ...
    public PedidoDistribuidor getPedidoDistribuidor() {
        return pedidoDistribuidor;
    }

    public void setPedidoDistribuidor(PedidoDistribuidor pedidoDistribuidor) {
        this.pedidoDistribuidor = pedidoDistribuidor;
    }
